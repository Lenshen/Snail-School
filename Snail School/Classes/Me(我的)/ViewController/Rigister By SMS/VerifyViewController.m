...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (alertView == _alert3) {
        SettingPassWordViewController *goodD =[[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"SettingPassWordViewController"];
        goodD.modalTransitionStyle = UIModalPresentationCustom;
        [self presentViewController:goodD animated:YES completion:nil];
...
- (void)viewDidLoad
{
    ...
    NSString *icon = [NSString stringWithFormat:@"button4.png"];
